<?= $this->extend('admin/adminLayout/settingLayout') ?>
            ...
            <div class="row">
                <div class="col-lg-6">
                    <div class="card card-large-icons">
                        ...
                        <div class="card-body">
                            <h4>Kelola Lowongan Kerja</h4>
                            <p>General settings such as, site title, site description, address and so on.</p>
                            <a href="/admin/setting/job" class="card-cta">Go to Setting <i class="fas fa-chevron-right"></i></a>
                        </div>
                    </div>
                </div>
                <div class="col-lg-6">
