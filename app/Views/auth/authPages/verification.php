            ...
            <div class="row">
                <div class="col-12 col-sm-10 offset-sm-1 col-md-8 offset-md-2 col-lg-8 offset-lg-2 col-xl-8 offset-xl-2">
                    ...
                    <div class="card card-primary">
                        ...
                        <div class="card-body">
                            <p class="text-muted">Resend Your Mail Verification</p>
                            <?= form_open('', 'id="form-verification" role="form" method="post"') ?>
                            ...
                            <div class="form-group">
                                <button type="submit" class="btn btn-primary btn-lg btn-block" tabindex="4" id="btn-submit" disabled>Forgot Password</button>
                            </div>
                            <?= form_close() ?>
                        </div>
                    </div>
